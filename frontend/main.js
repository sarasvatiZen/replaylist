...
var $author$project$Main$loginStatusDecoder = $elm$json$Json$Decode$dict($elm$json$Json$Decode$bool);
var $author$project$Main$fetchLoginStatus = $elm$http$Http$get(
	{
...
var $author$project$Main$serviceFromType = function (sType) {
	switch (sType.$) {
		case 'Apple':
			return {icon: 'assets/AppleMusicIcon.png', loginLabel: 'Login with AppleMusic', name: 'AppleMusic'};
		case 'Youtube':
...
var $author$project$Main$appleLogin = _Platform_outgoingPort(
	'appleLogin',
	function ($) {
		return $elm$json$Json$Encode$null;
	});
var $author$project$Main$PlaylistItem = F6(
	function (id, name, cover, trackCount, checked, tracks) {
		return {checked: checked, cover: cover, id: id, name: name, trackCount: trackCount, tracks: tracks};
	});
...
var $author$project$Main$decodePlaylistItem = A7(
	...
	A2($elm$json$Json$Decode$field, 'track_count', $elm$json$Json$Decode$int),
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
					...
					$elm$http$Http$post(
						{
							...
							expect: $elm$http$Http$expectWhatever(
								function (_v1) {
									return $author$project$Main$FetchLoginStatusAfterApple;
								}),
			...
			case 'UrlChanged':
				var url = msg.a;
				var _v4 = $author$project$Main$parseState(url);
				var leftL = _v4.a;
				var rightL = _v4.b;
				var li = _v4.c;
				var curFrom = A2(
			...
			case 'GotSpotifyPlaylists':
				if (msg.a.$ === 'Ok') {
					...
					var decoded = A2(
						...
						_List_Nil,
						A2($elm$json$Json$Decode$decodeString, $author$project$Main$decodeSpotifyPlaylists, raw));
					return _Utils_Tuple2(
						_Utils_update(
							model,
			...
			case 'GotApplePlaylists':
				if (msg.a.$ === 'Ok') {
					...
					var decoded = A2(
						$elm$core$Result$withDefault,
						_List_Nil,
						A2($elm$json$Json$Decode$decodeString, $author$project$Main$decodeApplePlaylists, raw));
					return _Utils_Tuple2(
						_Utils_update(
							model,
							...
							$elm$core$Platform$Cmd$batch(
								_List_fromArray(
									[
										...
										$elm$core$Task$perform,
										function (_v7) {
											return $author$project$Main$AppleLoginAgain;
										},
			...
			case 'FetchLoginStatusAfterApple':
				return _Utils_Tuple2(model, $author$project$Main$fetchLoginStatus);
			case 'AppleLoginAgain':
				return _Utils_Tuple2(
					model,
					$author$project$Main$appleLogin(_Utils_Tuple0));
...
var $author$project$Main$leftCard = F5(
	function (model, service, currentFromType, currentFromIndex, fromOptions) {
		...
		var disableNext = _Utils_eq(
			currentFromIndex,
			$elm$core$List$length(fromOptions) - 1);
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('card card-left')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('card-icon')
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$src(service.icon),
									$elm$html$Html$Attributes$class('music-icon')
								]),
							_List_Nil)
						])),
					A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('arrow-btn left'),
									$elm$html$Html$Events$onClick($author$project$Main$PrevService),
									$elm$html$Html$Attributes$disabled(disablePrev)
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('◁')
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('service-label')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text(service.name)
								])),
							A2(
							$elm$html$Html$button,
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('arrow-btn right'),
									$elm$html$Html$Events$onClick($author$project$Main$NextService),
									$elm$html$Html$Attributes$disabled(disableNext)
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('▷')
					...
					_List_fromArray(
						[
							$elm$html$Html$text(service.loginLabel)
						]))
				]));
	});
...
var $author$project$Main$rightCard = F3(
	function (model, service, currentToType) {
		...
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('card card-right')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('service-name-right')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text(service.name)
...
var $author$project$Main$viewRow = function (p) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$type_('checkbox'),
						$elm$html$Html$Attributes$checked(p.checked),
						$elm$html$Html$Events$onCheck(
						function (b) {
							return A2($author$project$Main$ToggleOne, p.id, b);
						})
					]),
				_List_Nil),
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('cell meta')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$src(p.cover),
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('cell tracks')
					]),
				_List_fromArray(
					[
						A2(
	...
	switch (_v0.$) {
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('swap-container')
									]),
								_List_fromArray(
									[
										A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('swap-btn'),
		...
		default:
			return (!model.totalTransfers) ? A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('done-container')
					]),
				_List_fromArray(
					[
						A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('done-message')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Migration done!')
							]))
					])) : A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('done-loading-container')
					]),
				_List_fromArray(
					[
						A2(
	...
	switch (_v0.$) {
		case 'Home':
			var loggedInList = A2(
				...
				$elm$core$Dict$toList(model.loginStatuses));
			var loggedInText = $elm$core$List$isEmpty(loggedInList) ? 'Not Logged in any service yet' : ('Already logged in: ' + A2(
				$elm$core$String$join,
				', ',
...
var $author$project$Main$navLink = F3(
	function (label, msg, active) {
		return active ? A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('nav active')
				]),
			_List_fromArray(
				[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('RE:PLAYLIST')
					])),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						'home',
						$author$project$Main$GoHome,
						_Utils_eq(model.body, $author$project$Main$Home)),
						$elm$html$Html$text(' | '),
						A3(
						$author$project$Main$navLink,
						'list',
						$author$project$Main$GoList,
						_Utils_eq(model.body, $author$project$Main$List)),
						$elm$html$Html$text(' | '),
						A3(
						$author$project$Main$navLink,
						'done',
